class Workout {
  static List<Workout> list = [
    Workout("5 MIN WARM UP", "jkv-RMuigaA", "Dies kann man vor jeder Art von Training tun."),
    Workout("20 MIN FULL BODY WARM UP","wswdAzOfU1Y", "Ein intensives Ganzkörper-Workout, das man ohne Ausrüstung durchführen kann, wo und wann man will. Es beansprucht die Muskeln des gesamten Körpers und bringt einen ganz schön ins Schwitzen." ),
  ...
  Workout(this.title, this.youtubeId, this.description) {}
